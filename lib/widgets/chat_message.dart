...
import 'package:boty_flutter/widgets/cached_image_bubble.dart';
  ...
  void _showContextMenu(BuildContext context, Offset position) {
    ...
    showMenu(
      ...
      position: RelativeRect.fromRect(
        position & const Size(40, 40), // Rectangle at position
      ...
      if (value == 'copy') {
        ...
        showDialog(
          ...
          builder: (ctx) => AlertDialog(
            title: const Text("¿Eliminar de tu sistema?"),
            content: const Text(
              "Esto borrará el mensaje de tu base de datos, pero el usuario aún podrá verlo en su WhatsApp.\n\nLa API de WhatsApp no permite eliminar mensajes de texto ya entregados.",
            ),
            actions: [
              TextButton(
              ...
              TextButton(
                onPressed: () {
                  Navigator.pop(ctx);
                  chatProvider.deleteMessage(message.user, message.id ?? 0);
                },
                child: const Text(
                  "Eliminar",
